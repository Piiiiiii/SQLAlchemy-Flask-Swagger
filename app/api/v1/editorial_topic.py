...
@api.route('/create_editorial_topic')
@api.doc()
def create_editorial_topic():
    ...
    message = Editorial_topic.create_editorial_topic(
        # user_id=user_id,
...
@api.route('/delete_topic')
@api.doc()
def delete_topic():
    request_body = request.get_json()
    # user_id = request_body['user_id']
    editorial_topic_id = request_body['editorial_topic_id']
    message = Editorial_topic.delete_topic(
        # user_id=user_id,
        editorial_topic_id=editorial_topic_id)
    return message


@api.route('/delete_article_from_topic')
@api.doc()
def delete_article_from_topic():
    ...
    message = Editorial_topic.delete_article_from_topic(
        # user_id=user_id,
        editorial_topic_id=editorial_topic_id,
